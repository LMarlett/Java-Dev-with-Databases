...
public class Jimenez {
    ...
    public static void main(String[] args) {
         ...
         try {
            ...
            /* StormtrooperUnit.displayStormtroopers(StUnitList);         
             for(StormtrooperUnit stormtrooperU : StUnitList )   { 
            System.out.println(stormtrooperU.getSTUID());
            }*/
        ...
        try {
         ...
         /*  for(Stormtrooper stormtrooper : StList )   { 
            System.out.println(stormtrooper.getRank());
            }*/
        } catch (SQLException ex) {
            Logger.getLogger(Jimenez.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
