...
import exam2jimenez.Interfaces.Attack;
 ...
 * @author lillimj
 */
public class Infantry extends StormtrooperUnit implements Movement, Report, Attack {

    public Infantry(String STUID, String UnitCmd, String UnitType, int AssignedStrength, int Location_X, int Location_Y, int HQ_LocationX, int HQ_LocationY) {
    ...
    @Override
    public void AttackPosition(Location L) {
